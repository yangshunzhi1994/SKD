...
class Decoder(nn.Module): # Feature map distillation of thin nets for low-resolution object recognition
    def __init__(self):
...
def Absdiff_Similarity(student, teacher): # Feature map distillation of thin nets for low-resolution object recognition
